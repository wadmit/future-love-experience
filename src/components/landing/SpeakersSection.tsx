...
const SpeakersSection = () => {
  return <section id="speakers" className="section-padding bg-secondary relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6 mb-16">
          ...
          animationDelay: `${(index + 3) * 100}ms`
              ...
              <div className="flex justify-center gap-4">
                ...
                <a href={speaker.social.linkedin} className="w-9 h-9 rounded-full bg-secondary-foreground/10 flex items-center justify-center hover:bg-primary/20 hover:text-primary transition-colors duration-200">
                  <Linkedin className="w-4 h-4 text-secondary-foreground/60" />
                </a>
                <a href={speaker.social.instagram} className="w-9 h-9 rounded-full bg-secondary-foreground/10 flex items-center justify-center hover:bg-primary/20 hover:text-primary transition-colors duration-200">
