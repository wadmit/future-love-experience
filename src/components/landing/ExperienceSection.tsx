...
const experiences = [
  {
    ...
    description:
      "Master the art of brushwork with traditional ink and rice paper. Write your name in beautiful Chinese characters.",
  ...
  },
  {
    ...
    description:
      "Personalized academic advice and dedicated support for parents.",
